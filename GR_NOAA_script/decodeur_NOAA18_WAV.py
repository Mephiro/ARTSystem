...
# Author: F4IMY
# Generated: Sat Feb 11 23:00:56 2023
##################################################
...
class decodeur_NOAA18_WAV(gr.top_block):
...
def main(top_block_cls=decodeur_NOAA18_WAV, options=None):
